...
import numpy as np
from tolerancing.geometry import Geometry, GeometryType, GeoCalculator
...
p1 = Geometry(GeometryType.POINT, [0, 0, 0])
p2 = Geometry(GeometryType.POINT, [3, 4, 0])
...
p = Geometry(GeometryType.POINT, [2, 2, 0])
ax = Geometry(GeometryType.AXIS, [0, 0, 0], [1, 0, 0])  # X-axis
...
ax1 = Geometry(GeometryType.AXIS, [0, 0, 0], [1, 0, 0])  # X-axis
ax2 = Geometry(GeometryType.AXIS, [0, 0, 0], [0, 1, 0])  # Y-axis
...
ax = Geometry(GeometryType.AXIS, [1, 1, 1], [1, 1, 1])  # Diagonal axis
pl = Geometry(GeometryType.PLANE, [0, 0, 3], [0, 0, 1])  # Z=3 plane
...
pl1 = Geometry(GeometryType.PLANE, [0, 0, 0], [1, 0, 0])  # YZ plane
pl2 = Geometry(GeometryType.PLANE, [0, 0, 0], [0, 1, 0])  # XZ plane
...
p = Geometry(GeometryType.POINT, [5, 0, 0])
sph = Geometry(GeometryType.SPHERE, [0, 0, 0], r=3)
...
sph1 = Geometry(GeometryType.SPHERE, [0, 0, 0], r=5)
sph2 = Geometry(GeometryType.SPHERE, [8, 0, 0], r=5)
...
print("\n8. Contains Check:")
p = Geometry(GeometryType.POINT, [1, 2, 0])
cyl = Geometry(GeometryType.CYLINDER, [0, 0, 0], [0, 0, 1], r=3)  # Z-axis cylinder
